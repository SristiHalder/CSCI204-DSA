...
public class GeneratedArray {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("\nQuicksort:");
        measureSortTime(array, GeneratedArray::quicksort);


        System.out.println("Merge Sort:");
        measureSortTime(array, GeneratedArray::mergeSort);


        System.out.println("\nInsertion Sort:");
        measureSortTime(array, GeneratedArray::insertionSort);


        System.out.println("\nSelection Sort:");
        measureSortTime(array, GeneratedArray::selectionSort);
